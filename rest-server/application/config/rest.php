...
|
*/
$config['rest_auth'] = 'basic'; //menggunakan authentikasi basic
...
|
*/
$config['auth_source'] = ''; //seharusanya 'ldap', tidak menggunakan (dikosongkan) karena basic auth
...
|
*/
$config['rest_valid_logins'] = ['admin' => '1234', 'firnan' => 'firnan123']; //username dan password Authorization
...
|
*/
$config['rest_enable_keys'] = true; //untuk menghidupkan key maka TRUE
...
*/
$config['rest_enable_limits'] = true; //true untuk enable limits
