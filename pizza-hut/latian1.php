<?php
	...
	$menu = json_decode($data, true); //menggunakan json decode untuk mengambil data, dan true untuk array, jika tidak diberikan true maka jadi objek

	//var_dump($menu["menu"][0]["nama"]); //untuk memunculkan Meat Lover pada key menu pizza.json
	$menu = $menu['menu']; //untuk mengeluarkan key menu
	//echo $menu[0]["nama"]; 
?>
